...
# Configuration for `BedrockMantleMistralModelProvider`.
...
public isolated distinct client class BedrockMantleMistralModelProvider {
    *ai:ModelProvider;
    ...
    # + model - A Mistral model id. Any id the endpoint serves may be passed as a `string`
    ...
    public isolated function init(
            @display {label: "Model"} MistralMantleModel|string model,
            ...
            @display {label: "Configuration"} *MistralMantleConfig config)
            returns ai:Error? {
        Route|error resolved = resolveMantleRoute(model, region, api);
        [Route, readonly & ModelConverter, BedrockTransport] [route, converter, transport] =
            check resolveSpine("BedrockMantleMistralModelProvider", credentials, resolved, endpoint,
        ...
        check validateParamsForRoute("BedrockMantleMistralModelProvider", route.shape, converter, resolvedParams);
