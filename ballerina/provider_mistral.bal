...
public enum MistralModel {
    # Mistral Large 3 — the current flagship (675B, 256K context). Chat-completion
    # dialect on InvokeModel and Converse; dual-homed with Mantle, defaults to
    # Converse here.
    ...
    *ai:ModelProvider;
    ...
    public isolated function init(
        ...
        [Route, readonly & ModelConverter, BedrockTransport] [route, converter, transport] =
            check resolveSpine("MistralModelProvider", resolvedCredentials, model, region, endpointConfig, routeConfig,
        ...
        check validateParamsForRoute("MistralModelProvider", route.family, converter, resolvedParams);
        ...
        [ApiFamily, string, readonly & ModelConverter, BedrockTransport, map<string>]
            ...
            check resolveGenerateSpine("MistralModelProvider", resolvedCredentials, credentials, model, region, endpointConfig,
