    ...
    *ai:ModelProvider;
    ...
    public isolated function init(
        ...
        [Route, readonly & ModelConverter, BedrockTransport] [route, converter, transport] =
            check resolveSpine("AmazonModelProvider", resolvedCredentials, model, region, endpointConfig, routeConfig,
        ...
        check validateParamsForRoute("AmazonModelProvider", route.family, converter, resolvedParams);
        ...
        [ApiFamily, string, readonly & ModelConverter, BedrockTransport, map<string>]
            ...
            check resolveGenerateSpine("AmazonModelProvider", resolvedCredentials, credentials, model, region, endpointConfig,
